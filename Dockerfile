...
ARG NEXT_PUBLIC_PAYSTACK_PUBLIC_KEY=pk_test_invalid_key
ARG PAYSTACK_SECRET_KEY=sk_test_invalid_key
...
# Accept runtime environment variables from build args
