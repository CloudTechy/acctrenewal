...
CREATE INDEX IF NOT EXISTS idx_hotspot_locations_display_toggles ON hotspot_locations(show_logo, show_location_badge, show_display_name, show_welcome_message, show_description, show_guest_access);
...
-- Update existing locations to have all elements visible by default
...
-- SELECT id, name, display_name, show_logo, show_location_badge, show_display_name, show_welcome_message, show_description, show_guest_access FROM hotspot_locations; 